...
const AddCraft = () => {
  ...
  return (
    <div className="lg:px-20 px-5">
      ...
      <form onSubmit={hundleAddCaft} className="border border-gray-200 p-3 lg:p-5">
        {/* ----form row--- */}
        <div className="md:flex gap-4  w-full">
          <div className="md:w-1/2 mt-2 flex flex-col items-start gap-2">
            <label className="font-semibold" htmlFor="">Item Name:</label> 
            <input
              name="name"
              type="text"
          ...
          <div className="md:w-1/2 mt-2 flex flex-col items-start gap-2">
            <label className="font-semibold" htmlFor="">Subcategory Name:</label>  
            <input
              name="subcategory"
              type="text"
              className="input w-full input-bordered join-item"
        ...
        <div className="md:flex gap-4 w-full">
          <div className="md:w-1/2 mt-2 flex flex-col items-start gap-2">
            <label className="font-semibold" htmlFor="">Customization:</label> 
            <input
              name="customization"
              type="text"
              className="input w-full input-bordered join-item"
        ...
        <div className="md:flex gap-4 w-full">
          <div className="md:w-1/2 mt-2 flex flex-col items-start gap-2">
            <label className="font-semibold" htmlFor="">Processing Time:</label> 
            <input
              name="time"
              type="text"
              className="input w-full input-bordered join-item"
          ...
          <div className="md:w-1/2 mt-2 flex flex-col items-start gap-2">
            <label className="font-semibold" htmlFor="">Stock Status :</label> 
            <input
              name="stockStatus"
              type="text"
              className="input w-full input-bordered join-item"
